...
import { GroceryCategory, GroceryItem, GroceryPriority, useGroceryStore } from '@/src/store/grocery-store';
...
const PlannerFormCard = () => {
  ...
  const handleQuantityChange = (value : string) => {
    // This regex is used to remove all the non-numeric characters from the input
  ...
  return (
    ...
    style={{
        marginTop: insets.top + 20,       // Pushes the card safely below the notch
        marginBottom: insets.bottom + 80, //Pushes the card safely above the tab bar
      }}
    >
        {/* NAME */}
